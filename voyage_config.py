...
AREA_ENCOUNTERS = {
    ...
    2: {"fish": 50, "island": 18, "calm": 16, "pirate": 16},                 # 逃げ＆防衛で凌げる
    3: {"fish": 34, "island": 12, "pirate": 24, "calm": 6,  "boss": 4,  "maelstrom": 20},  # 初期装備ではほぼ死ぬ
    4: {"fish": 24, "island": 10, "pirate": 28, "calm": 4,  "boss": 12, "abyss": 22},      # 最深部・即死級
}
