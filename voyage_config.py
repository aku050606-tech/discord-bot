...
CRAFT_RECIPES = {'forge_tide_sword': {'kind': 'weapon',
                      'item': 'forge_tide_sword',
                      'rank': 2,
                      'cost': {'plain_wood': 72,
                               'beast_hide': 52,
                               'green_ore': 42,
                               'tide_iron': 42,
                               'driftwood_core': 48,
                               'small_magic_stone': 14}},
 'forge_tide_twin': {'kind': 'weapon',
                     'item': 'forge_tide_twin',
                     'rank': 2,
                     'cost': {'beast_hide': 64,
                              'meadow_sinew': 12,
                              'green_ore': 33,
                              ...
                              'blue_glass_sand': 25,
                              'small_magic_stone': 14}},
 'forge_coral_staff': {'kind': 'weapon',
                       'item': 'forge_coral_staff',
                       'rank': 2,
                       'cost': {'plain_wood': 84,
                                'old_cloth': 28,
                                'sun_grass': 42,
                                ...
                                'shallow_coral': 51,
                                'foam_pearl': 11,
                                'small_magic_stone': 17}},
 'forge_green_bow': {'kind': 'weapon',
                     'item': 'forge_green_bow',
                     'rank': 2,
                     'cost': {'plain_wood': 92,
                              'plant_fiber': 52,
                              'meadow_sinew': 12,
 ...
 'forge_tide_gun': {'kind': 'weapon',
                    ...
                    'cost': {'rough_stone': 72,
                             ...
                             'tide_iron': 57,
                             'foam_pearl': 10,
                             'small_magic_stone': 18}},
 'forge_core_greatsword': {'kind': 'weapon',
                           'item': 'forge_core_greatsword',
                           'rank': 2,
                           'cost': {'rough_stone': 86,
                                    'beast_bone': 56,
                                    'green_ore': 51,
                                    ...
                                    'driftwood_core': 69,
                                    'tide_iron': 63,
                                    'small_magic_stone': 19}},
 'forge_coral_mail': {'kind': 'armor',
                      'part': 'torso',
                      'item': 'forge_coral_mail',
                      'rank': 2,
                      'cost': {'beast_hide': 84,
                               'beast_bone': 52,
                               'rough_stone': 76,
                               ...
                               'foam_pearl': 11,
                               'small_magic_stone': 18}},
 'forge_tide_greaves': {'kind': 'armor',
                        'part': 'legs',
                        'item': 'forge_tide_greaves',
                        'rank': 2,
                        'cost': {'beast_hide': 72,
                                 'plant_fiber': 48,
                                 'meadow_sinew': 12,
