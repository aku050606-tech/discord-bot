...
# モンテカルロ調整済み：平均≈1,496/セット・昇格≈0.11/セットで、戻り率は
#   設定1≈108.5% / 設定6≈137〜138%（=従来据え置き）。設定差はGOD内部には一切出さない。
GOD_SET_GAMES = 10            # 1セットのゲーム数
GOD_PAYOUT_SCALE = 1.015      # 戻り率の一括調整ダイヤル（後告知ゲーム1回分のベットを吸収済み）

# 1ゲーム子役（全設定・全ルート共通）: (キー, 出現率, 昇格率, 基本払い出し, 表示名, emoji)
#   昇格率は「そのゲームで昇格を試みる確率」。1セット最大1回まで反映。
GOD_GAME_KOYAKU = [
    ("strong", 0.040, 0.30, 400, "強チェリー", "🌠"),  # 大コイン＋昇格本命
    ("suika",  0.090, 0.06, 250, "スイカ",     "🍉"),
    ("cherry", 0.110, 0.00, 160, "チェリー",   "🍒"),
