...
LAND_AREAS = {
    ...
    3: {"name": "山", "emoji": "⛰️", "req_lv": 15, "base": 34, "scale": 2.60,  # 山再調整：弱すぎたため32/2.45→34/2.60
        "xp": [270, 380], "coin": [900, 2000],
...
LAND_ENEMIES = {
    ...
    3: [  # ⛰️ 山：Lv25＋☆2フル装備を基準。雑魚でも手応え、中ボスは明確な危険枠。
        ...
        {"name": "若いワイバーン",   "emoji": "🐲",  "ratio": 1.16, "hp_mult": 1.06, "atk_mult": 0.46, "tier": 3, "stars": 3},  # 山の事故枠を少し緩和
    ],
}
...
RARE_BOSS_BY_AREA = {
    ...
    3: {"crew_power": 105, "scale": 2.35, "hp_mult": 1.75, "atk_mult": 0.62, "tier": 5, "stars": 4},  # 塔騎士：危険枠のまま少し緩和
}
...
LAND_MIDRARES = {
    ...
    3: [  # ⛰️ 山 ☆3
        {"name": "古竜のなりそこない", "emoji": "🐲", "ratio": 2.25, "hp_mult": 1.45, "atk_mult": 0.42, "tier": 3, "stars": 3,
         "xp": [900, 1250], "coin": [4500, 9000], "drop": [("dist", 0.03, [(1, 0.70), (2, 0.29), (3, 0.01)])]},
        {"name": "石の巨人",       "emoji": "🗿", "ratio": 2.00, "hp_mult": 1.60, "atk_mult": 0.39, "tier": 3, "stars": 3,
         "xp": [900, 1250], "coin": [4500, 9000], "drop": [("dist", 0.03, [(1, 0.70), (2, 0.29), (3, 0.01)])]},
        {"name": "山の魔女",       "emoji": "🧙", "ratio": 2.15, "hp_mult": 1.38, "atk_mult": 0.44, "tier": 3, "stars": 3,
         "xp": [900, 1250], "coin": [4500, 9000], "drop": [("dist", 0.03, [(1, 0.70), (2, 0.29), (3, 0.01)])]},
    ],
}
