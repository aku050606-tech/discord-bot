...
SKILLS = {
    ...
    "shukketsu": {
        ...
        "acc": 0.9, "charge": 0, "dot_power": 0.29, "dot_turns": 3, "price": 8000,
    ...
    # ━━━━━ 白兵技 ☆3（実効1.35倍・技ガチャ専用 price=0）━━━━━
    "kyougeki3": {
        "name": "強撃・改", "emoji": "⚔️", "phase": "board", "slot": "weapon",
        "wtypes": ["sword", "gun", "greatsword"], "rank": 3,
        "type": "attack", "power": 2.05, "hits": 1, "cost": 0, "cooldown": 2,
        "acc": 0.95, "charge": 0, "price": 0,
        "desc": "☆3。強撃の上位。個人力の2.05倍。",
    },
    "rengeki3": {
        "name": "連撃・改", "emoji": "🌀", "phase": "board", "slot": "weapon",
        "wtypes": ["twin", "bow"], "rank": 3,
        "type": "attack", "power": 0.68, "hits": 3, "cost": 0, "cooldown": 2,
        "acc": 0.9, "charge": 0, "price": 0,
        "desc": "☆3。連撃の上位。三連撃が冴え渡る。",
    },
    "konshin3": {
        "name": "渾身斬り・改", "emoji": "💢", "phase": "board", "slot": "weapon",
        "wtypes": ["staff", "greatsword"], "rank": 3,
        "type": "attack", "power": 2.7, "hits": 1, "cost": 0, "cooldown": 0,
        "acc": 1.0, "charge": 1, "price": 0,
        "desc": "☆3。溜めて放つ極大の一撃。",
    },
    "shukketsu3": {
        "name": "出血斬り・改", "emoji": "🩸", "phase": "board", "slot": "weapon",
        "wtypes": ["sword", "katana", "twin"], "rank": 3,
        "type": "dot", "power": 0.6, "hits": 1, "cost": 0, "cooldown": 2,
        "acc": 0.9, "charge": 0, "dot_power": 0.39, "dot_turns": 3, "price": 0,
    ...
    "oukyu3": {
        ...
        "wtypes": ["staff"], "rank": 3,
        "type": "heal", "power": 0.0, "hits": 1, "cost": 0, "cooldown": 1,
        "acc": 1.0, "charge": 0, "heal_flat": 55, "heal_ratio": 0.0, "price": 0,
        "desc": "☆3。より多くのHPを回復する。",
    },
    "snipe3": {
        "name": "狙撃・改", "emoji": "🎯", "phase": "board", "slot": "weapon",
        "wtypes": ["bow", "gun"], "rank": 3,
        "type": "attack", "power": 2.4, "hits": 1, "cost": 0, "cooldown": 3,
        "acc": 0.95, "charge": 0, "price": 0,
        "desc": "☆3。狙撃の上位。個人力の2.4倍。",
    },
    "piercing3": {
        "name": "貫通弾・改", "emoji": "🔩", "phase": "board", "slot": "weapon",
        "wtypes": ["gun", "bow"], "rank": 3,
        "type": "pierce", "power": 1.79, "hits": 1, "pierce": 0.65, "cost": 0, "cooldown": 2,
        "acc": 0.95, "charge": 0, "price": 0,
    ...
    "issen3": {
        ...
        "type": "attack", "power": 2.75, "hits": 1, "cost": 0, "cooldown": 4,
        "acc": 1.0, "charge": 0, "price": 0,
        "desc": "☆3。一閃の極み。個人力の2.75倍。",
    },
    "teppeki3": {
        "name": "鉄壁・改", "emoji": "🛡️", "phase": "board", "slot": "armor", "rank": 3,
        "type": "defend", "power": 0.0, "hits": 0, "cost": 0, "cooldown": 1,
        "acc": 1.0, "charge": 0, "reduce": 0.8, "price": 0,
