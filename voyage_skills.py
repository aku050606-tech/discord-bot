...
SKILLS = {
    ...
    "kyougeki": {
        ...
        "type": "attack", "power": 1.7, "hits": 1, "cost": 0, "cooldown": 2,
    ...
    "rengeki": {
        ...
        "wtypes": ["twin", "sword"],
        "type": "attack", "power": 0.6, "hits": 3, "cost": 0, "cooldown": 2,
        "acc": 0.9, "charge": 0, "price": 6000,
        "desc": "素早い三連斬り。1発は軽いが手数で押し切る。双剣と好相性。",
    },
    "konshin": {
        "name": "渾身斬り", "emoji": "💢", "phase": "board", "slot": "weapon",
        "wtypes": ["staff", "greatsword"],
        "type": "attack", "power": 2.6, "hits": 1, "cost": 0, "cooldown": 0,
