...
class Database:
    ...
    def initialize(self):
        ...
        c.execute("""CREATE TABLE IF NOT EXISTS member_profiles (
            ...
            about_q1 TEXT, about_a1 TEXT, about_q2 TEXT, about_a2 TEXT, about_q3 TEXT, about_a3 TEXT, free_text TEXT, badges TEXT, custom_badge TEXT, profile_theme TEXT,
            PRIMARY KEY (guild_id, user_id)
        )""")
        # 既存DB向けの安全な列追加
        c.execute("PRAGMA table_info(member_profiles)")
        existing_cols = {row[1] for row in c.fetchall()}
        for col in ('about_q1','about_a1','about_q2','about_a2','about_q3','about_a3','free_text','badges','custom_badge','profile_theme'):
    ...
    def get_member_profile(self, guild_id, user_id):
        conn=self.get_conn(); c=conn.cursor()
        keys=("nickname","hobby","comment","mbti","games","about_q1","about_a1","about_q2","about_a2","about_q3","about_a3","free_text","badges","custom_badge","profile_theme")
    ...
    def update_member_profile(self, guild_id, user_id, **fields):
        allowed_keys={"nickname","hobby","comment","mbti","games","about_q1","about_a1","about_q2","about_a2","about_q3","about_a3","free_text","badges","custom_badge","profile_theme"}
